...
public class SanaUtil
{
    ...
    abstract public static class Closure<T>
    {
        protected Object[] args;

        public Closure(Object... a)
        {
            args = a;
        }

        public abstract T run(Object... args2);
    }


    abstract public static class NamedClosure<T> extends Closure<T>
    {
        private String name;

        public NamedClosure(String n, Object... a)
        {
            super(a);
            name = n;
        }
